...
@interface KLMGRoomVoteKillCell : UIView
@property (nonatomic, strong) UIImage *KLactivityStylehour; //Image in the panorama view
@property (nonatomic) CGFloat KLtopicEntranceView; //Duration of one image animation (greater is longer; default:10s)
